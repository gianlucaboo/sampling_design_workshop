...
::::: columns
::: {.column width="33%"}
![Iris setosa (source: Wikipedia)](https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Kosaciec_szczecinkowaty_Iris_setosa.jpg/500px-Kosaciec_szczecinkowaty_Iris_setosa.jpg){width="225"}
:::

::: {.column width="33%"}
![Iris versicolor (source: Wikipedia)](https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Iris_versicolor_3.jpg/500px-Iris_versicolor_3.jpg)
:::
:::::

::: {.column width="33%"}
![Iris Virginica (source: Wikipedia)](https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Iris_virginica.jpg/500px-Iris_virginica.jpg)
:::
