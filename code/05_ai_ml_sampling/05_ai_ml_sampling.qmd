...
**Combined approach**  
    -   Use **random-forest predictions** as inputs to **k-means** to create strata based on both observed and modelled variables\
...
ML is powerful but should be **handled carefully**. Below a few key paramteres to consider: 
...
ℹ️ Please do consult additional references.
