...
All the course materials are available on a dedicated [GitHub repository](https://github.com/gianlucaboo/sampling_design_workshop/).

![](img/github.png){width="100%"}
...
2.  Click on **Day 3: Introduction to R programming**
3.  **Copy the url** and **paste it** on https://download-directory.github.io
4.  Save the zipped directory in `C:\\sampling_design` and unzip it
...
::: embed
<iframe src="https://gallery.shinyapps.io/050-kmeans-example/" width="100%" height="350">
...
ℹ️ Try to navigate through the different panes.
...
-   Assign values using `<-` (`Alt` + `-` (minus sign) on Windows and Linux, and `Option` + `-` on a Mac).
...
-   R and RStudio are relatively difficult to learn at the beginning\
-   Once you master the basis it is much easier to move forward\
-   R cheatsheets are an excellent resource for beginners\

![](img/r_cheatsheet.png)

ℹ️ Most R cheatsheet can be found here: <https://rstudio.github.io/cheatsheets/contributed-cheatsheets.html>.
...
Please download the R script with exercises from [GitHub](https://github.com/gianlucaboo/sampling_design_workshop/blob/main/code/01_r_introduction/01_r_introduction_exercise.R) and try to complete it.
