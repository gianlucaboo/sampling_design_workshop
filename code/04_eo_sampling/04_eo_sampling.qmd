...
author: "Earth observation (EO) data for sampling design"
...
2.  Click on **Day 6: Earth observation (EO) for sampling design**
...
## EO data for sampling

::::: columns
::: {.column width="50%"}
-   **Up-to-date spatial coverage**
    -   Complements or updates outdated census and survey frames
    -   Detects new settlements, urban growth, and rural changes
-   **Population distribution and density**
    -   Proxy indicators: night-time lights, building footprints, land cover
    -   Supports stratification and proportional allocation of samples
:::

::: {.column width="50%"}
-   **Environmental and contextual variables**
    -   NDVI, elevation, climate, accessibility data
    -   Enable stratified sampling by ecological or geographic conditions
-   **Improved sampling efficiency**
    -   Helps identify hard-to-reach or hidden populations
    -   Reduces cost and field effort by targeting relevant areas
:::
:::::

![A gridded sampling design (source: Boo et al. 2020)](img/sampling_workflow.gif){fig-align="left"}
...
Open [**GEE Code Editor**](https://code.earthengine.google.com/) and follow the following **step-by-step** (more [here](https://scienceparkstudygroup.github.io/GoogleEarthEngine/02-code-editor/)):

```         
1.  Sign in with a Google account (example: samplingworkshop\@gmail.com)\
2.  Click New Script
...
Hijmans, R. J. (2023). *terra: Spatial Data Analysis*. R package version 1.7-36. https://cran.r-project.org/package=terra

R Core Team. (2025). *R: A Language and Environment for Statistical Computing*. R Foundation for Statistical Computing, Vienna, Austria. https://www.R-project.org

Gorelick, N., Hancher, M., Dixon, M., Ilyushchenko, S., Thau, D., & Moore, R. (2017). *Google Earth Engine: Planetary-scale geospatial analysis for everyone*. Remote Sensing of Environment, 202, 18–27. https://developers.google.com/earth-engine
...
Please download the R script with exercises from [GitHub](https://github.com/gianlucaboo/sampling_design_workshop/blob/main/code/04_eo_sampling/04_eo_sampling_exercise.R) and try to complete it.
