...
-   Always reflect **strata**, **clusters**, and **weights** in the design object

------------------------------------------------------------------------

## Choosing a Design — Practical Tips
...
-   Always retain design variables (stratum, cluster, weights) in the dataset
...
svyquantile(~y, svy, c(0.5)) # weighted median
```
